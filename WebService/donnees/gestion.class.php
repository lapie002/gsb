...
class Gestion
{
	static public function lister($classe, $fields=null, $values=null,$orderby=null,$orderdir=null,$ps=false)//true si ps
	{
		try
		{
			...
			{
                                $pdo->setRequeteLister($classe,$fields, $values,$orderby,$orderdir);
			}
			$sql=$pdo->getRequete();
