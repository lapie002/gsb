...
class PDO3 extends PDO { // PDO3 h�rite de PDO
	...
	public function setRequeteLister($classe, $fields=null, $values=null,$orderby=null,$orderdir=null)//avec ou sans h�ritage
	{	
		try
		{
			$sql;
			...
			else
			{
                                ...
                                for($i=0;$i<count($orderby);$i++)
				{
                                ...
                                $sql = rtrim($sql, ","); //suppression du AND
                                $sql.=' '.$orderdir;
                            }else{
